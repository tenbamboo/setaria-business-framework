export const rightRichTextSponsors = [
  {
    ...
    url: 'https://www.misboot.com/?from=setaria-business-framework',
...
export const rightLogoSmallSponsors = [
  {
    ...
    url: 'https://wonderful-code.gitee.io/?from=setaria-business-framework',
...
export const leftCustomImgSponsors = [
  {
    ...
    url: 'https://js.design/?source=setaria-business-framework&plan=sy',
