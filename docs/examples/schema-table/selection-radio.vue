<template>
  <el-button @click="setSelection">设置选中第一个</el-button>
...
const handleSelectionChange = (selectionList, currentItem) => {
  console.log('selectionchange', selectionList, currentItem)
}

const setSelection = () => {
  schemaTableRef.value?.setSelection(dataList[0])
}
const getSelection = () => {
  console.log(schemaTableRef.value?.getSelection())
}
const clearSelection = () => {
  schemaTableRef.value?.clearSelection()
}
</script>
