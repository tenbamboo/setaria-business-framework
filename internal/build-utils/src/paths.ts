...
export const epRoot = resolve(pkgRoot, 'setaria-business-framework')
...
/** `/dist/setaria-business-framework` */
export const epOutput = resolve(buildOutput, 'setaria-business-framework')
